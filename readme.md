...
A zero configuration, zero dependency test runner for ECMAScript Modules—made specifically for getting started quick. If you eventually decide to switch to the bigger guns, *you don't have to rewrite your tests*.
